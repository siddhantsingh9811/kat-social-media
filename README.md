...
## Hosting
The backend ~~is~~ was hosted on digital ocean and the frontend was hosted through Vercel [here](https://kat-five.vercel.app/) However the backend is no longer hosted so functionality is limited.
